# RFDELTA Top Option Trades - 2026-06-19
...
MARA wins the top slot because liquidity, directional alignment and bounded payoff reinforce one another. Its credit entry of 0.11 creates 0.28 dollars of maximum reward for each dollar of maximum risk, with breakeven at $12.89.

SMCI supplies the counterweight. Its put credit structure scores 47.42 and carries $79.00 of one-lot maximum loss. The basket is therefore ranked as a portfolio of explicit risks, not as five unrelated ticker calls.
...
|---:|---|---:|---:|---:|---:|---:|---:|
| 1 | MARA 7/3 13/12.5 Put Credit Spread | Credit 0.11 | 70.8% | -$2.51 | $39.00 | $11.00 | 55.70 |
| 2 | SMCI 7/3 28/27 Put Credit Spread | Credit 0.21 | 70.4% | -$6.47 | $79.00 | $21.00 | 47.42 |
| 3 | RGTI 7/3 19.5/19 Put Credit Spread | Credit 0.12 | 63.9% | -$5.44 | $38.00 | $12.00 | 44.48 |
| 4 | QUBT 7/3 10.5/10 Put Debit Spread | Debit 0.26 | 45.0% | -$3.41 | $26.00 | $24.00 | 34.50 |
| 5 | SOFI 7/3 17.5/16.5 Put Debit Spread | Debit 0.37 | 36.3% | -$3.22 | $37.00 | $63.00 | 33.16 |

### 1. MARA 7/3 13/12.5 Put Credit Spread

**Actionable watch.** The setup scores 55.70 on the common scale, supported by 70.8% modeled probability of profit, 0.80 liquidity quality and a conservative modeled expectancy of -$2.51, which keeps sizing discipline central.
...
**Payoff:** Maximum one-lot profit is $11.00, or 0.28 times maximum risk. The simulation assigns 68.9% probability to finishing near maximum profit and uses 82.0% implied volatility across deterministic jump-stress paths.

### 2. SMCI 7/3 28/27 Put Credit Spread
...
**Risk:** Maximum one-lot loss is $79.00. Breakeven is $27.79 and sits 9.5% below the source mark, providing a downside cushion. Primary watch: negative conservative BS edge. A break in the stated directional regime invalidates the reason for holding even when the contractual maximum loss remains unchanged.

**Payoff:** Maximum one-lot profit is $21.00, or 0.27 times maximum risk. The simulation assigns 68.9% probability to finishing near maximum profit and uses 84.0% implied volatility across deterministic jump-stress paths.

### 3. RGTI 7/3 19.5/19 Put Credit Spread

**Trigger-dependent setup.** The setup scores 44.48 on the common scale, supported by 63.9% modeled probability of profit, 0.78 liquidity quality and a conservative modeled expectancy of -$5.44, which keeps sizing discipline central.
...
**Payoff:** Maximum one-lot profit is $12.00, or 0.32 times maximum risk. The simulation assigns 62.8% probability to finishing near maximum profit and uses 103.0% implied volatility across deterministic jump-stress paths.

### 4. QUBT 7/3 10.5/10 Put Debit Spread

**Trigger-dependent setup.** The setup scores 34.50 on the common scale, supported by 45.0% modeled probability of profit, 0.81 liquidity quality and a conservative modeled expectancy of -$3.41, which keeps sizing discipline central.
...
**Payoff:** Maximum one-lot profit is $24.00, or 0.92 times maximum risk. The simulation assigns 40.5% probability to finishing near maximum profit and uses 102.0% implied volatility across deterministic jump-stress paths.

### 5. SOFI 7/3 17.5/16.5 Put Debit Spread
...
|---|---|---:|---|
| SPCE 6/18 4.5/5 Call Debit Spread | loss | -$6.00 | Expired below the long strike; the defined debit was the full loss. |
| SOUN 6/18 7/7.5 Call Debit Spread | near breakeven | -$1.00 | Settled close to entry after reaching the lower strike. |
| OPEN 6/18 4.5/5 Call Debit Spread | loss | -$12.00 | Expired just below the long strike and lost the debit. |
| SPCE 6/18 4/4.5 Call Debit Spread | loss | -$14.00 | Expired below the long strike and lost the debit. |
| NVDA 6/15 205/202.5 Put Credit Spread | win | $83.00 | Expired out of the money; the full opening credit was retained. |
...
RFDELTA June 2026 historical calibration set. Data timestamp: Jun 19, 2026, 11:45 AM EDT. Historical calibration editions are clearly labeled and are never promoted as current market data.
